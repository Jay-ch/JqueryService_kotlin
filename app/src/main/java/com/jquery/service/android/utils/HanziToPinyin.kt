...
class HanziToPinyin {
    ...
    private var mHasChinaCollator: Boolean?=false
   ...
   constructor(hasChinaCollator: Boolean):super() {
    ...
    fun getPinYin(input: String): String {
        val tokens = HanziToPinyin(true).getInstance().get(input)
        val sb = StringBuilder()
