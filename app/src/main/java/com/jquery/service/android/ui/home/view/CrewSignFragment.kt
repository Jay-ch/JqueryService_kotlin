 ...
 */
class CrewSignFragment : BaseFragment() {
    var index: Int = 0
    ...
    private fun initRecentWork() {
        var map1 = RecentWorkItem("11.31", "签到[成功]", 2, "重庆市南岸区骑龙山庄3区7幢401", "2018.11.31  10:46:45")
        var map2 = RecentWorkItem("12.01", "签到[成功]", 2, "重庆市南岸区骑龙山庄3区7幢405", "2018.12.01  10:46:45")
        var map3 = RecentWorkItem("12.02", "签到[未成功]", 2, "重庆市南岸区骑龙山庄3区7幢402", "2018.12.02  10:46:45")
        var map4 = RecentWorkItem("12.03", "签到[成功]", 2, "重庆市南岸区骑龙山庄3区7幢402", "2018.12.02  10:46:45")
