...
class GridImageAdapter : RecyclerView.Adapter<GridImageAdapter.ViewHolder> {
    ...
    constructor(context: Context, mOnAddPicClickListener: onAddPicClickListener) : super() {
    ...
    fun setList(list: List<LocalMedia>) {
        this.list = list as MutableList<LocalMedia>
    }
    ...
    inner class ViewHolder(view: View) : RecyclerView.ViewHolder(view) {
        ...
        internal var ll_add: LinearLayout
        ...
        init {
            ...
            ll_add = view.findViewById<View>(R.id.ll_add) as LinearLayout
        }
    }
    ...
    override fun onBindViewHolder(viewHolder: ViewHolder, position: Int) {
        ...
        if (getItemViewType(position) == TYPE_CAMERA) {
            viewHolder.ll_add.visibility = View.VISIBLE
            //viewHolder.mImg.setImageResource(R.drawable.fault_detail_add)
            viewHolder.mImg.setOnClickListener { mOnAddPicClickListener.onAddPicClick() }
            viewHolder.ll_del.visibility = View.INVISIBLE
        } else {
            viewHolder.ll_add.visibility = View.GONE
