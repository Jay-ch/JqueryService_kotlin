 ...
 */
class CrewFaultFragment : BaseFragment() {
    var index: Int = 0
    override fun createLayout(): Int {
        return R.layout.fragment_crew_fault_layout
    }
    ...
    private fun initRecentWork() {
        var map1 = RecentWorkItem("11.30", "故障维修（完成）", 1, "重庆市南岸区骑龙山庄3区7幢401", "2018.11.31  10:46:45")
        var map2 = RecentWorkItem("11.31", "故障维修（未完成）", 1, "重庆市南岸区骑龙山庄3区7幢401", "2018.11.31  10:46:45")
