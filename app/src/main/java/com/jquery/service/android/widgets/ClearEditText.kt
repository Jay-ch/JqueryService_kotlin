 ...
 * 输入框清除
 * @author J.query
 * @date 2019/4/3   extends AppCompatEditText implements View.OnFocusChangeListener, TextWatcher
...
class ClearEditText : AppCompatEditText, View.OnFocusChangeListener, TextWatcher {
    ...
    private fun init() {
        ...
        if (mClearDrawable == null) {
            ...
            mClearDrawable = resources.getDrawable(R.drawable.ic_search_clear)
        }
